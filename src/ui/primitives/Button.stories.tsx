...
const meta = {
  ...
  argTypes: {
    kind: {
      ...
      description: 'Visual intent. `primary` = ember hero · `arcane` = AI/magic · `danger` = destructive.',
    },
...
export const Secondary: Story = { args: { kind: 'secondary', children: 'Maybe later' } }

export const Ghost: Story = { args: { kind: 'ghost', children: 'Dismiss' } }

/** AI / magic actions use the arcane violet. */
export const Arcane: Story = { args: { kind: 'arcane', children: 'Conjure a character' } }

/** Destructive actions use the blood red. */
export const Danger: Story = {
  args: { kind: 'danger', children: 'Delete scene', iconLeft: <Trash2 size={16} strokeWidth={1.75} /> },
}
