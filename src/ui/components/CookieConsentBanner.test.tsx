...
const setPage = vi.fn()
const navStub: NavValue = { currentPage: 'landing', previousPage: undefined, setPage, goBack: vi.fn(), cardEdit: null, resourceEdit: null, replaceHash: vi.fn(), currentHash: '', registerNavigationInterceptor: () => () => {} }
