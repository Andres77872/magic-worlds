/**
 * End-user side of the credit-code system: a small affordance in the
 * membership area that redeems a code via `POST /billing/credit-codes/redeem` and
...
const FORM_ID = 'credit-code-redemption-form'

export function CreditCodeRedemptionCard({ onRedeemed }: CreditCodeRedemptionCardProps) {
