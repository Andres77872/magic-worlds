 ...
 * gallery pages' compact density columns).
 */
export const CARD_GRID_CLASS =
    'grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-4 md:grid-cols-[repeat(auto-fill,minmax(220px,1fr))] md:gap-5'
