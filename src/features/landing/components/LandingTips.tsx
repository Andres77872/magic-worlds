    ...
    return (
        <section className="landing-tips-section animate-entrance" aria-labelledby="tips-title">
            ...
            <div className="landing-tips-grid">
                <div className="landing-tip-card animate-entrance" style={{animationDelay: '0.1s'}}>
                ...
                <div className="landing-tip-card animate-entrance" style={{animationDelay: '0.2s'}}>
                ...
                <div className="landing-tip-card animate-entrance" style={{animationDelay: '0.3s'}}>
